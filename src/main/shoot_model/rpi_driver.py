...
class ShootModelDriver:
    def __init__(self):
        ...
        try:
            model_path = "ShootModel_Lite_2D_FINAL.tflite"
    ...
    def run(self):        
        ...
        while True:
            # if (not NetworkTableInstance.getDefault().isConnected()):
            #     NetworkTableInstance.getDefault().startClient4("RPI_CLIENT")
            #     NetworkTableInstance.getDefault().setServerTeam(2854)
            #     NetworkTableInstance.getDefault().startDSClient()
            # else:    
    ...
    def set_input(self):
        ...
        ty = NetworkTableInstance.getDefault().getTable("limelight").getEntry("ty").getDouble(0) / 100.00
