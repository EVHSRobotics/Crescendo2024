...
public class ShootNoteSourceFar extends Command {
 ...
 private final SwerveRequest.FieldCentric drive = new SwerveRequest.FieldCentric()
  ...
  public ShootNoteSourceFar(Arm arm, Intake intake, Shooter shoot) {
...
// runningInitializeIntake = true;
    ...
    // arm.setPosition(-0.0275);
    arm.setPosition(Vision.getPredTheta()+0.007);
    shoot.motionMagicVelo(90);
